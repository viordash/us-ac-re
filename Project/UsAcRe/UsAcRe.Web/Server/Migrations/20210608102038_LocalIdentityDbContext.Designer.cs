...
namespace UsAcRe.Web.Server.Migrations {
	...
	[Migration("20210608102038_LocalIdentityDbContext")]
	partial class LocalIdentityDbContext {
...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity("UsAcRe.Web.Server.Identity.ApplicationIdentityRoleClaim", b => {
				b.Property<int>("Id")
					.ValueGeneratedOnAdd()
					.HasColumnType("int")
					.HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
			...
			modelBuilder.Entity("UsAcRe.Web.Server.Identity.ApplicationIdentityUser", b => {
				b.Property<Guid>("Id")
					.ValueGeneratedOnAdd()
					.HasColumnType("uniqueidentifier");
			...
			modelBuilder.Entity("UsAcRe.Web.Server.Identity.ApplicationIdentityUserClaim", b => {
				b.Property<int>("Id")
					.ValueGeneratedOnAdd()
					.HasColumnType("int")
					.HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
			...
			modelBuilder.Entity("UsAcRe.Web.Server.Identity.ApplicationIdentityUserClaim", b => {
				b.HasOne("UsAcRe.Web.Server.Identity.ApplicationIdentityUser", null)
					.WithMany()
